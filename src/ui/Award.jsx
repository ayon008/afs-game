                                            ...
                                            if (a.position === '1st') {
                                                return (
                                                    <div key={i} className='2xl:p-10 xl:p-6 p-4 award 2xl:h-[490px] xl:h-[410px] h-[340px] flex flex-col'>
                                                        ...
                                                        <div className='mt-auto grid grid-cols-3 gap-2 w-full overflow-hidden items-end'>
                                                            <img src={a.sponsors1} className='w-full max-h-[65px]' alt='' />
                                                            <img src={a.sponsors2} className='w-full max-h-[65px]' alt='' />
                                                            <img src={a.sponsors3} className='w-full max-h-[65px]' alt='' />
                                                        </div>
                                                    </div>
                                                )
                                            }
