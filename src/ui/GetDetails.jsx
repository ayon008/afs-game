                ...
                <td colSpan={'9'} className='p-0'>
                    <div className='bg-black rounded-t-[20px] 2xl:p-10 xl:p-6 p-4 grid 2xl:grid-cols-4 xl:grid-cols-4 grid-cols-2 2xl:gap-0 xl:gap-0 gap-6'>
                        <div className='border-r-2 border-[#FFE500]'>
                            <h2 className='2xl:text-3xl xl:text-xl text-xs font-bold text-white'>{user?.city} {user?.pays}</h2>
                        ...
                        <div className='2xl:border-r-2 xl:border-r-2 2xl:border-[#FFE500] xl:border-[#FFE500] 2xl:ml-2 xl:ml-2'>
                            <div className='2xl:w-fit 2xl:mx-auto xl:w-fit xl:mx-auto'>
                                <h2 className='2xl:text-3xl xl:text-xl text-xs font-bold text-white'>{time || 'N/A'}</h2>
                        ...
                        <div className='border-r-2 border-[#FFE500] 2xl:ml-2 xl:ml-2'>
                            <div className='2xl:w-fit 2xl:mx-auto xl:w-fit xl:mx-auto'>
                                <h2 className='2xl:text-3xl xl:text-xl text-xs font-bold text-white'>{Math.abs(parseInt(pointTable?.session)) || 'N/A'}</h2>
                        ...
                        <div>
                            <div className='w-fit 2xl:ml-auto xl:ml-auto'>
                                {
                                    (pointTable?.total) ? <h2 className='2xl:text-3xl xl:text-xl text-xs font-bold text-white'>{Math.abs(parseInt((pointTable?.total)))?.toFixed(2)} KM</h2> : <h2 className='2xl:text-3xl xl:text-xl text-xs font-bold text-white'>N/A</h2>
