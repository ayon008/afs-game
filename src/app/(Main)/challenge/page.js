...
const page = () => {
    return (
        <div className='2xl:pt-16 xl:pt-16'>
            ...
            <h3 className='2xl:text-3xl xl:text-2xl text-base px-6 text-center font-medium text-white 2xl:mt-11 xl:mt-11 mt-8 2xl:mb-48 xl:mb-32 mb-20'>Vous pourrez ensuite suivre votre progression dans le <br /> classement !</h3>
            <Join />
        </div>
    );
};
