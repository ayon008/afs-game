    ...
    return (
        <div>
            <div className='m-[10px] relative'>
                ...
                />
                <h2 className={`${antiHero.className} text-white 2xl:text-7xl xl:text-5xl font-bold absolute left-24 bottom-10`}>Défis de <br /> l&apos;événement</h2>
            </div>
            ...
            <div className='2xl:px-40 xl:px-28 2xl:mt-28 xl:mt-16'>
                ...
                <div className='2xl:h-[420px ] points 2xl:p-5 xl:p-4 rounded-[10px] xl:h-[300px] flex flex-col justify-between'>
                    ...
                    <div>
                        <p className='uppercase font-semibold text-white 2xl:textarea-lg xl:text-sm'>Réservé aux participants sur les <span className={`${antiHero.className} text-blue-500`}>4 disciplines</span></p>
