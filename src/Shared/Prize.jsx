        ...
        <div className='bg-black rounded-xl flex flex-col h-fit w-[90%] mx-auto'>
            <div className='flex items-center w-full h-full'>
                <div className='bg-[#FFE500] h-full py-[15px] pl-[23px] pr-[12px] rounded-custom'>
                    <h1 className='text-black 2xl:text-5xl xl:text-5xl text-3xl font-bold'>{position}<sup className='2xl:text-base xl:text-sm text-xs uppercase font-medium align-super'>{sup}</sup></h1>
                </div>
