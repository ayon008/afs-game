        ...
        <div className='px-[10px]'>
            <div className='px-5 bg-black rounded-[10px]'>
                <div className='2xl:px-[140px] xl:px-20 2xl:py-20 xl:py-[60px]'>
                    <p className='text-white font-medium xl:text-5xl 2xl:text-7xl '>Rejoignez-nous et prenez part à la première édition des <span className={`${antiHero.className} text-yellow-500`}>AFS GAMES ONLINE 2024</span>, rencontrez des passionnés et participez à des challenges inédits. </p>
                    ...
                    <div className='2xl:mt-7 xl:mt-5 flex items-start 2xl:gap-20 xl:gap-16'>
                        ...
                        <p className=' 2xl:text-xl xl:text-sm font-semibold text-white'>Emplacement-<span className={`${antiHero.className} text-yellow-500`}>ONLINE</span> <br /> PRIX-<span className={`${antiHero.className} text-yellow-500`}>Free</span></p>

                        <p className='text-yellow-500 2xl:text-xl xl:text-sm font-semibold  flex items-center gap-2'>
