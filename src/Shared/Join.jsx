            ...
            <div className='px-5 rounded-[10px] z-40'>
                <div className={`2xl:px-[140px] xl:px-20 2xl:py-20 xl:py-[60px]  px-4 py-10`}>
                    ...
                    <p className={`${morgana.className} text-white font-medium text-2xl xl:text-5xl 2xl:text-7xl mt-8`}>
                        <span className="text-[#FFE500]">Join us</span> and take part in the first edition of the <span className={`text-[#FFE500]`}>AFS GAMES ONLINE 2024</span>, meet enthusiasts and participate in unique challenges.
                    </p>
                    ...
                    <div className='2xl:mt-7 xl:mt-5 mt-7 flex 2xl:flex-row xl:flex-row flex-col items-start 2xl:gap-20 xl:gap-16 gap-8'>
                        ...
                        <p className={`${morgana.className} 2xl:text-[40px] xl:text-3xl text-sm font-semibold text-white`}>
                            from Monday <span className='text-[#FFE500]'>September 30</span> to Sunday <span className='text-[#FFE500]'>November 3</span>
                        </p>
                    </div>
                    <p className='text-[#666] 2xl:text-sm xl:text-[10px] xl:leading-[10px] text-[6px] font-normal mt-5'>
                        <span className='text-[#FFE500]'>*</span>The AFS client is defined as a practitioner owning at least one AFS foil and using it in the competition. The choice of board and wing is free.
                    </p>
                </div>
            </div>
